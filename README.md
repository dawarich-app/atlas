...
| `build-app` | published release or manual dispatch on its tag, after tests pass | `ghcr.io/dawarich-app/atlas/app:0.6.0`, `:0.6`, `:latest`, `:sha-<sha>` (amd64+arm64) |
...
installation to 0.6.0. Update the checkout as well as the image: Compose and
